...
module.exports = (db) => {
  // Route untuk mengambil data dari tabel 'pzem017' berdasarkan tanggal dan validasi secretkey
  router.get('/:secretkey/:date', (req, res) => {
    ...
    const query = 'SELECT id, voltage, current, power, energy, updated_at FROM pzem017 WHERE updated_at LIKE ? ORDER BY updated_at DESC';
